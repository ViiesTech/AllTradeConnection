    ...
    <MainContainer>
      <Header2 headerText3='' hideCancel text={'Get Gold'} subHeading={''} />
        ...
        <View style={{alignItems: 'center'}}>
            <ImageBackground imageStyle={{borderRadius: 20}} source={images.cardBg} style={{padding: responsiveHeight(2), width: responsiveWidth(90),}}>
                                ...
                                <Text style={{fontSize: responsiveFontSize(7),  fontWeight: 'bold', color: colors.secondary}}>$1600</Text>
                                <Text style={{fontSize: responsiveFontSize(2), marginTop: responsiveHeight(3), fontWeight: 'bold', color: colors.secondary}}>/Month</Text>
                                </View>
                                </View>

                            <View style={{marginHorizontal: responsiveHeight(1.5), paddingBottom: responsiveHeight(2)}}>
                                <Text style={{color: colors.secondary, fontSize: responsiveFontSize(2.5), width: responsiveWidth(80), marginTop: responsiveHeight(1)}}>Free for ever when you host with Debbi. free for freelancers with Client Billing</Text>
                            </View>
                                </ImageBackground>
