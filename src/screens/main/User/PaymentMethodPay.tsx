...
const PaymentMethodPay = () => {
    ...
    const data = [
        ...
        {id: 3, title: '$230.000', textStyle: {fontWeight: 'bold', fontSize: responsiveFontSize(4), color: colors.black}},
    ]
  return (
    <MainContainer>
    <Header2 headerText3='' hideCancel text={''} subHeading={''} />
        ...
        <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
            <FlatList
                ...
                renderItem={({item}) => {
                    return (
                        <View style={item.id === 3 && {width: responsiveWidth(90), marginTop: responsiveHeight(5), padding: responsiveHeight(2), borderRadius: 10, borderWidth: 1, borderColor: colors.line_color, justifyContent: 'center', alignItems: 'center'}}>
 ...
 <View style={{flex: 1, justifyContent: 'flex-end', marginBottom: responsiveHeight(2)}}>
    <Button style={{ marginTop: responsiveHeight(3.5), width: responsiveWidth(90) }} onPress={() => nav.navigate(ROUTES.CONFIRM_PAYMENT)} buttonText='Continue' />}
    </View>
        </View>
    </MainContainer>
  );
