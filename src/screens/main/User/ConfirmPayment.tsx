...
import { confirmPaymentFields, responsiveFontSize, responsiveHeight, responsiveWidth, ROUTES } from '../../../utils';
...
const ConfirmPayment = () => {
  ...
  return (
    <MainContainer>
    <Header2 headerText3='' hideCancel text={'Confirm Payment'} subHeading={'Please check carefully the validation of your payment before sending'} />
    ...
    <View style={{padding: responsiveHeight(3), }}>
        ...
        <CustomInputForm inputContainer={{width: responsiveWidth(80)}} buttonStyle={{width: responsiveWidth(80)}} inputStyle={{color: 'black'}} inputContainerStyle={{marginTop: responsiveHeight(0)}} onSubmit={(values) => nav.navigate(ROUTES.TRANSACTION)} initialValues={{paymenttype: 'plumbing',phonenumber: '043223423423', nameaccount: 'John', amount: '$250.00', fee: '$120.00'}} validationSchema={validationSchema} buttonText='Pay Now' fields={confirmPaymentFields} />
    </View>
    </MainContainer>
  );
};
